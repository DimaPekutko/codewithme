...
from .schemas import FullProblem, ProblemForUpdate, LangProblemForUpdate, CodeAssertionForUpdate, UpdateActiveLangs, \
    UpdateCategories
from . import models
...
@inject
async def new_problem(user: User = Depends(get_user),
                      problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])) -> FullProblem:
    return await problem_cases.new_problem(user)


@router.get("/problems")
@inject
async def problems(user: User = Depends(get_user),
...
@inject
async def lang_problem(lproblem_id: int, user: User = Depends(get_user),
                       problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
...
@inject
async def toggle(problem_id: int, user: User = Depends(get_user),
                 problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
...
@inject
async def categories(user: User = Depends(get_user),
                     problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
...
@inject
async def update_problem(problem_id: int,
...
@inject
async def update_categories(problem_id: int,
...
@inject
async def update_active_langs(problem_id: int,
...
@inject
async def update_lang_problem(lproblem_id: int, payload: LangProblemForUpdate, user: User = Depends(get_user),
                              problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
...
@inject
async def update_assertion(assertion_id: int, payload: CodeAssertionForUpdate, user: User = Depends(get_user),
                           problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
...
@inject
async def delete_assertion(assertion_id: int, user: User = Depends(get_user),
                           problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
...
@inject
async def add_assertion(lang_problem_id: int, user: User = Depends(get_user),
                        problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
...
@inject
async def delete_problem(problem_id: int, user: User = Depends(get_user),
                         problem_cases: ProblemCases = Depends(Provide[Container.problem_cases])):
